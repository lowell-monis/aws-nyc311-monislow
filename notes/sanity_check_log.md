...
- **What I expected:** I expected NYPD to be the fastest agency due to their higher budget and emergent nature of their work.
- **Issues encountered:** Query failed initially due to false assumption of data to only include closed complaints.
